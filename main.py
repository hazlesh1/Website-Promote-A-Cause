...
Keep the scenarios, questions, and options short, simple, and casual, as if you're talking directly to them in a conversation.
...
Crucially, ensure that the correct (healthy/active) answer is randomized and alternates between options 'a', 'b', and 'c' across the 5 generated scenarios.
Make all three options sound believable and relatable — don't make the wrong or neutral answers obviously bad. The correct answer shouldn't be immediately obvious.
